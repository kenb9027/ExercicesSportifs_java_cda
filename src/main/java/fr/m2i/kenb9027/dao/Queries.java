...
public class Queries {
    ...
    //EXERCICES
    public static final String EXERCICE_CREATE = "INSERT INTO exercice (date, timeStart, timeEnd, machineDeSport) VALUES (?, ?, ?, ?)";
    ...
    public static final String EXERCICE_DELETE_ONE_BY_ID = "";
